    ...
    <div className='flex flex-col gap-2 md:pr-0 pr-5' data-aos="fade-right">
      ...
      <div className='flex flex-col gap-5 max-h-96 overflow-y-auto py-4'>
        {news
          ...
          .map((item, index) => (
          <Link to={`/news-detail/${item.id}`} key={index} className='md:w-82 mx-auto p-4 rounded bg-gray-100 shadow-md hover:shadow-lg hover:-translate-y-2 duration-500 border-l-4 border-transparent hover:border-yellow-400'>
            <div className='headline2 overflow-hidden'>
              ...
              <h1 className='font-semibold text-red-500 text-sm leading-tight mb-2 line-clamp-1'>{item.title}</h1>
