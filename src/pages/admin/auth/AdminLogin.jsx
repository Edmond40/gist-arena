      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
          <div className="mb-6 text-center">
            ...
            <p className="text-sm text-gray-600 mt-1">Only administrators can access the dashboard.</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-700">
            Need an account?{' '}
            <Link className="text-yellow-700 hover:text-yellow-800 font-medium" to="/admin/register">Create an admin account</Link>
          </p>
        </div>

        <p className="mt-4 text-center text-xs text-gray-600">
          Not an admin? <Link className="text-gray-900 font-medium hover:underline" to="/login">Go to user sign in</Link>
        </p>
      </div>
    </div>
  );
